#!/usr/bin/env python3
"""
Precise Servo Calibration Tool - MOUTH
...
print("\n" + "="*70)
print("PRECISE SERVO CALIBRATION - MOUTH (GPIO 22)")
print("="*70)
print("\nThis tool helps you find the exact servo range for your mechanism.")
print("\nServo values range from -1.0 (min) to +1.0 (max)")
print("You'll test different values to find what works for your mouth.")
print("\n" + "="*70)

# Start at neutral (0.0)
current_value = 0.0
mouth.value = current_value
...
try:
    ...
    if saved_positions:
        ...
        # Write to file
        with open('/home/tim/GairiHead/mouth_calibration.txt', 'w') as f:
            f.write("MOUTH SERVO CALIBRATION DATA\n")
            f.write("="*70 + "\n\n")
            for label, value in saved_positions.items():
                f.write(f"{label}: {value:.3f}\n")
        print("\n✓ Calibration data saved to: /home/tim/GairiHead/mouth_calibration.txt")
