#!/usr/bin/env python3
"""
Precise Servo Calibration Tool - RIGHT EYE
...
print("\n" + "="*70)
print("PRECISE SERVO CALIBRATION - RIGHT EYELID (GPIO 27)")
print("="*70)
...
current_value = 0.0
right_eyelid.value = current_value
...
try:
    ...
    if saved_positions:
        ...
        # Write to file
        with open('/home/tim/GairiHead/right_eye_calibration.txt', 'w') as f:
            f.write("RIGHT EYE SERVO CALIBRATION DATA\n")
            f.write("="*70 + "\n\n")
            for label, value in saved_positions.items():
                f.write(f"{label}: {value:.3f}\n")
        print("\n✓ Calibration data saved to: /home/tim/GairiHead/right_eye_calibration.txt")
